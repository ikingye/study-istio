...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/study-istio/flexsearch.min.js');loadScript('/study-istio/en.search-data.min.b4f5c512d3fbe2247acd9a7f2587407fa7c637357a05a548862676078978aced.js',function(){input.required=false;search();});}
