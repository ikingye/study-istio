...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/study-istio/flexsearch.min.js');loadScript('/study-istio/en.search-data.min.a0723519e2e781bbf693071024cdf4bc4fd8e0686dc56ac8aa244deff116c7ac.js',function(){input.required=false;search();});}
