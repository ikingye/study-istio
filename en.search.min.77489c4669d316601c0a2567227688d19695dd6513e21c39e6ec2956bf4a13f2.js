...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/study-istio/flexsearch.min.js');loadScript('/study-istio/en.search-data.min.1559457a350d6d3e39dc418d25227782fd8d9cb7ff53a6fe5120a84d9d6622a1.js',function(){input.required=false;search();});}
