...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/study-istio/flexsearch.min.js');loadScript('/study-istio/en.search-data.min.586fd92bd2b7174290099787182806d8346da61651f709059699851d406be3f9.js',function(){input.required=false;search();});}
