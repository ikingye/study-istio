...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/study-istio/flexsearch.min.js');loadScript('/study-istio/en.search-data.min.f8434f96ecdce04d4356b2faa057ef565017470a41012bb02ec5c1a456f7401f.js',function(){input.required=false;search();});}
