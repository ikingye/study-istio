...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/study-istio/flexsearch.min.js');loadScript('/study-istio/en.search-data.min.2c30596a56c44d6e99dfa09e093656b866dba944e3ddfce3cc6d3e3f383fe503.js',function(){input.required=false;search();});}
