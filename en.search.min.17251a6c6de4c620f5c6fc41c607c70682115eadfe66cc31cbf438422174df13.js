...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/study-istio/flexsearch.min.js');loadScript('/study-istio/en.search-data.min.75cd1dc7ecdc90c3081a986db8b0643aa004e59b7731a1795811f39836229a8b.js',function(){input.required=false;search();});}
