...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/study-istio/flexsearch.min.js');loadScript('/study-istio/en.search-data.min.f5e4544b87730ee4ead9d2adc0f9c35d8d9be6767fc127fb039dc07a1ad795d0.js',function(){input.required=false;search();});}
